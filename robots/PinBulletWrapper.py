...
from typing import Collection, Optional, List, Tuple, Iterable
...
class PinBulletWrapper:
    ...
    def __init__(self, robot_name:str, endeff_names: Optional[Iterable] = None, useFixedBase=False, reference_robot: Optional['PinBulletWrapper'] = None, init_q=None, hip_height=1.0):
        ...
        self._init_q = np.concatenate(([0, 0, 0, 0, 0, 0, 1], np.zeros(self.nj))) if init_q is None else np.array(init_q)
    ...
    def configure_bullet_simulation(self, bullet_client: BulletClient, world, base_pos=(0, 0, 0), base_ori=(0, 0, 0, 1)):
